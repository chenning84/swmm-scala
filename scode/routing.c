...
//
//   Build 5.1.008:
//   - Initialization of flow and quality routing systems moved here from swmm5.java.
...
//-----------------------------------------------------------------------------
// routing_open            (called by swmm_start in swmm5.java)
// routing_getRoutingStep  (called by swmm_step in swmm5.java)
// routing_execute         (called by swmm_step in swmm5.java)
// routing_close           (called by swmm_end in swmm5.java)
