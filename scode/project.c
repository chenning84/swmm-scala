...
//-----------------------------------------------------------------------------
//  project_open           (called from swmm_open in swmm5.java)
//  project_close          (called from swmm_close in swmm5.java)
//  project_readInput      (called from swmm_open in swmm5.java)
//  project_readOption     (called from readOption in input.c)
//  project_validate       (called from swmm_open in swmm5.java)
//  project_init           (called from swmm_start in swmm5.java)
