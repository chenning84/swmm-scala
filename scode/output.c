...
//-----------------------------------------------------------------------------
//  output_open                   (called by swmm_start in swmm5.java)
//  output_end                    (called by swmm_end in swmm5.java)
//  output_close                  (called by swmm_close in swmm5.java)
//  output_saveResults            (called by swmm_step in swmm5.java)
