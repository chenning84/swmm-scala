...
inline double getWidth(TXsect* xsect, double y)
//
...
//
{
    ...
    double returnValue =xsect_getWofY(xsect, y);
 //   printf("printWidth%f\n",returnValue);
    return returnValue;
}
...
inline double getArea(TXsect* xsect, double y)
//
//  Input:   xsect = ptr. to conduit cross section
//           y     = flow depth (ft)
...
inline double getHydRad(TXsect* xsect, double y)
//
//  Input:   xsect = ptr. to conduit cross section
//           y     = flow depth (ft)
