...
/**
 * Created by ning on 1/3/16.
 * 
 */
public class XSectDat {
    //-----------------------------------------------------------------------------
//   xsection.dat
//
//   Project:  EPA SWMM5
...
//=============================================================================
    ...
    public static int    N_A_Circ   = 51;
    public static double[] A_Circ = new double[]     // A/Afull v. Y/Yfull
    ...
    public static int    N_R_Circ   = 51;
    public static double[] R_Circ= new double[]      // R/Rfull v. Y/Yfull
    ...
    public static int    N_Y_Circ   = 51;
    public static double[] Y_Circ= new double[]     // Y/Yfull v. A/Afull
    ...
    public static int    N_S_Circ   = 51;
    public static double[] S_Circ= new double[]  // S/Sfull v. A/Afull
    ...
    public static int    N_W_Circ   = 51;
    public static double[] W_Circ= new double[]      // W/Wmax v. Y/Yfull
...
//=============================================================================
    ...
    public static int    N_A_Egg   = 26;
    public static double[] A_Egg= new double[]  
    ...
    public static int    N_R_Egg   = 26;
    public static double[] R_Egg= new double[]  
    ...
    public static int    N_Y_Egg   = 51;
    public static double[] Y_Egg= new double[]  
    ...
    public static int    N_S_Egg   = 51;
    public static double[] S_Egg= new double[]  
    ...
    public static int    N_W_Egg   = 26;
    public static double[] W_Egg= new double[]  
...
//=============================================================================
    ...
    public static int    N_A_Horseshoe   = 26;
    public static double[] A_Horseshoe= new double[]  
    ...
    public static int    N_R_Horseshoe   = 26;
    public static double[] R_Horseshoe= new double[]  
    ...
    public static int    N_Y_Horseshoe   = 51;
    public static double[] Y_Horseshoe= new double[]  
    ...
    public static int    N_S_Horseshoe   = 51;
    public static double[] S_Horseshoe= new double[]  
    ...
    public static int    N_W_Horseshoe   = 26;
    public static double[] W_Horseshoe= new double[]  
...
//=============================================================================
    ...
    public static int    N_Y_Gothic   = 51;
    public static double[] Y_Gothic= new double[]  
    ...
    public static int    N_S_Gothic   = 51;
    public static double[] S_Gothic= new double[]  
    ...
    public static int    N_W_Gothic   = 21;
    public static double[] W_Gothic= new double[]  
...
//=============================================================================
    ...
    public static int    N_Y_Catenary   = 51;
    public static double[] Y_Catenary= new double[]  
    ...
    public static int    N_S_Catenary   = 51;
    public static double[] S_Catenary= new double[]  
    ...
    public static int    N_W_Catenary   = 21;
    public static double[] W_Catenary= new double[]  
...
//=============================================================================
    ...
    public static int    N_Y_SemiEllip   = 51;
    public static double[] Y_SemiEllip= new double[]  
    ...
    public static int    N_S_SemiEllip   = 51;
    public static double[] S_SemiEllip= new double[]  
    ...
    public static int    N_W_SemiEllip   = 21;
    public static double[] W_SemiEllip= new double[]  
...
//=============================================================================
    ...
    public static int    N_A_Baskethandle   = 26;
    public static double[] A_Baskethandle= new double[]  
    ...
    public static int    N_R_Baskethandle   = 26;
    public static double[] R_Baskethandle= new double[]  
    ...
    public static int    N_Y_BasketHandle   = 51;
    public static double[] Y_BasketHandle= new double[]  
    ...
    public static int    N_S_BasketHandle   = 51;
    public static double[] S_BasketHandle= new double[]  
    ...
    public static int    N_W_BasketHandle   = 26;
    public static double[] W_BasketHandle= new double[]  
...
//=============================================================================
    ...
    public static int    N_Y_SemiCirc   = 51;
    public static double[] Y_SemiCirc= new double[]  
    ...
    public static int    N_S_SemiCirc   = 51;
    public static double[] S_SemiCirc= new double[]  
    ...
    public static int    N_W_SemiCirc   = 21;
    public static double[] W_SemiCirc= new double[]  
...
//=============================================================================
    ...
    public static int NumCodesEllipse = 23;

    //  Minor  axis (inches)
    public static double[] MinorAxis_Ellipse= new double[]  
    { 14,19,22,24,27,29,32,34,38,43,48,53,58,63,68,72,77,82,87,92,97,106,116};

    //  Major axis (inches)
    public static double[] MajorAxis_Ellipse= new double[]  
    { 23,30,34,38,42,45,49,53,60,68,76,83,91,98,106,113, 121,128,136,143,151,
            166,180};

    //  Full area (sq.ft.)
    public static double[] Afull_Ellipse= new double[]  
    ...
    public static double[] Rfull_Ellipse= new double[]  
...
//=============================================================================
    ...
    public static int    N_A_HorizEllipse   = 26;
    public static double[] A_HorizEllipse= new double[]  
    ...
    public static int    N_R_HorizEllipse   = 26;
    public static double[] R_HorizEllipse= new double[]  
    ...
    public static int    N_W_HorizEllipse   = 26;
    public static double[] W_HorizEllipse= new double[]  
...
//=============================================================================
    ...
    public static int    N_A_VertEllipse   = 26;
    public static double[] A_VertEllipse= new double[]  
    ...
    public static int    N_R_VertEllipse   = 26;
    public static double[] R_VertEllipse= new double[]  
    ...
    public static int    N_W_VertEllipse   = 26;
    public static double[] W_VertEllipse= new double[]  
    { .0,.3919,.5426,.6499,.7332,.8000,.8542,.8980,.9330,.9600,
            .9798,.9928,.9992,.9992,.9928,.9798,.9600,.9330,.8980,.8542,
            .8000,.7332,.6499,.5426,.3919,.0};
...
//=============================================================================
    ...
    public static int NumCodesArch = 102;

    public static double[] Yfull_Arch= new double[]       // NOTE: these are in inches
    {    
     /* Concrete */
    ...
    public static double[] Wmax_Arch= new double[]        // NOTE: these are in inches
    {
     /* Concrete */
    ...
    public static double[] Afull_Arch= new double[]  
    ...
    public static double[] Rfull_Arch= new double[]  
    ...
    public static int    N_A_Arch   = 26;
    public static double[] A_Arch= new double[]  
    ...
    public static int    N_R_Arch   = 26;
    public static double[] R_Arch= new double[]  
    ...
    public static int    N_W_Arch   = 26;
    public static double[] W_Arch= new double[]  
